...
CMD ["/opt/data/", "/opt/result/", "/opt/sampledata/metacohort.sif", "/opt/sampledata/metacohort.DOC_interval.avg_cvg.txt", "run1", "exome", "0.23", "0.01", "2", "150", "true", "true", "true", "None"]
